import argparse
from simple_fairseq.src.logger import create_logger
import os
import torch

import sys
sys.path.insert(0,'./simple_fairseq')
logger = create_logger('train.log')

parser = argparse.ArgumentParser(description='Settings')
parser.add_argument("--train_data", type=str, default='./simple_fairseq/data/120w.bin',
                    help="train data dir")
...
if __name__ == '__main__':
    ...
    params.checkpoint_dir = 'all_models/base_4gpu_1delay_fixrandom'
    #params.reload_model = 'all_models/base_2gpu_new/model_epoch19.pt'
    params.update_freq = 1
    params.seed = 1244
    # params.gpu_num = 4

    if params.gpu_num == 1:
        from simple_fairseq.single_train import main
        main(params)
    else:
        from simple_fairseq.multiprocessing_train import main
