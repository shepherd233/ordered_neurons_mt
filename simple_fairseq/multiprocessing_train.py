...
import threading
import random
from simple_fairseq.src.model import build_mt_model
from simple_fairseq.src.data.loader import load_data
from simple_fairseq.src.trainer import TrainerMT
from simple_fairseq.src.distributed_utils import suppress_output,is_master
...
def run(params, error_queue):
    try:
        ...
        for i in range(trainer.epoch, 25):
