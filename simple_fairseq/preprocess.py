...
if __name__ == '__main__':
    ...
    src_voc_path = 'huawei/dict.bpe.zh'
    src_txt_path = 'huawei/corpus.bpe.zh'
    tgt_voc_path = 'huawei/dict.bpe.en'
    tgt_txt_path = 'huawei/corpus.bpe.en'

    bin_path = 'huawei/120w.bin'
